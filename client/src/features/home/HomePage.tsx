    ...
    return (
        <Paper
            sx={{
                ...
                height: '100vh',
                backgroundImage: 'linear-gradient(135deg, #2234AB 0%, #45C1D1 69%, #B84AD9 89%)'
            }}
        >
            ...
            <Button component={Link} to='/activities' size="large" variant="contained" sx={{height: 80, borderRadius: 4, fontSize: '1.5'}}>
